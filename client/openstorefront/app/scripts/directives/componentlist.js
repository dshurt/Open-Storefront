...
app.directive('componentList', ['business', function (Business) {
  ...
  return {
    ...
    link: function postLink(scope, element, attrs) {
      ...
      element.find('.moreContent').attr('id', item);
      ...
      scope.setShown = function() {
        var id = element.find('.moreContent').attr('id');
